...
/**
 * This is the item provider adapter for a {@link webApplications.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPageIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Page_pageID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Page_pageID_feature", "_UI_Page_type"),
						WebApplicationsPackage.Literals.PAGE__PAGE_ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						WebApplicationsPackage.Literals.PAGE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Page_description_feature",
								"_UI_Page_type"),
						WebApplicationsPackage.Literals.PAGE__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case WebApplicationsPackage.PAGE__PAGE_ID:
		case WebApplicationsPackage.PAGE__NAME:
		case WebApplicationsPackage.PAGE__DESCRIPTION:
